      ...
      <body className={inter.className}>
        <div className="min-h-screen flex flex-col">
          ...
          <div className="bg-white border-b border-gray-200">
            <div className="max-w-[680px] mx-auto flex items-center justify-center py-2 px-2.5 relative">
              <Link href="/" className="logo">PLATES.AE</Link>
              <div className="absolute right-2.5 text-[12px] text-gray-500 hidden md:block">
          ...
          <nav className="bg-primary-red">
            <div className="max-w-[680px] mx-auto">
              <div className="flex justify-between items-center px-2.5 py-1.5 flex-wrap gap-0 main-nav-row">
              ...
              <div className="flex justify-between border-t border-white/25 px-2.5 py-1 main-nav-row">
